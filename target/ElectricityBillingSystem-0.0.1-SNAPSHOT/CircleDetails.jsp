...
<form method="post" action="CircleServlet">
		...
		<table align="center" style="padding: 3px 40px">
			...
			<tr>
				<td><input type="number" name="circle_no" placeholder="circle no"
					required /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="circle_name" placeholder="Circle Name"
					required /></td>
			</tr>
			<tr>
			...
			<tr>
				<td><input type="text" name="division_name" placeholder="Division name"
					required /></td>
			</tr>
