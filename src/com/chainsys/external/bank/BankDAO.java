...
public class BankDAO {
	...
	/* start */
	public BigDecimal balanceEnquiryExtensionMethod(Bank bank) throws ClassNotFoundException {
		System.out.println("get bal: "+bank);
		try {
			...
			while (resultSet.next()) {
				System.out.println("Acc bal : "+resultSet.getBigDecimal("balance"));
	...
	public Bank getAccountInformation(Payee payee) throws ClassNotFoundException {
	...
	public Payee getTransactionInformation(Payee payee) throws ClassNotFoundException {
	...
	/* end */
	public int NEFTTransfer(Payee payee) throws ClassNotFoundException {
		int r1 = 0,  r3 = 0, r5 = 0;
		try {
